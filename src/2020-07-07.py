...
def evaluate_features(matrix, t0=11, t1=22, drop_cols=['ID', 'price']):
    ...
    return err, importances, score_drop
...
def add_some_features(matrix, train, items):
    ...
    matrix[['date_item_shop_avg_item_lag_1', 'item_cnt_month_lag_1', 'item_cnt_month']].corr()
    #          tr       val
    # 0  0.744336  1.244755
    # 1  0.679208  1.063184
    # 2  0.669135  1.028535
    ...
    matrix = pd.read_parquet('../data_tmp/tmp4.snappy')
    # new_features = []
