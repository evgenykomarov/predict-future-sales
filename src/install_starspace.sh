...
set(PYTHON_LIBRARY '\home\komarov\anaconda3\lib\')
set(PYTHON_INCLUDE_DIR '\home\komarov\anaconda3\include\python3.7m\')
chmod +x build.sh
./build.sh

cp test/starwrap.so /home/komarov/anaconda3/lib/python3.7/site-packages/
