...
import pickle
pickle.dump(model, open('../data/model_xgb_2020-06-02.pkl', "wb"))
model = pickle.load(open('../data/model_xgb_2020-06-02.pkl', "rb"))
...
submission.to_csv('../data/xgb_submission_2020-06-19_03.csv', index=False)
pd.Series(Y_pred).to_csv('../data/xgb_submission_2020-06-19_03_valid.csv', index=False)
